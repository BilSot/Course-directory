const TeacherList = [
  ...
  {
    name: "Geo 'Lo' Cation",
    bio: "Geo is a CourseContainer developer working on large-scale applications. He's also a teacher who strives to support students in removing all barriers to learning code.",
    img_src: "http://treehouse-code-samples.s3.amazonaws.com/bootstrap-4/img/geo.png",
    id: "teach-3"
  },
  {
    name: "Ecma Scriptnstuff",
    bio: "Ecma found her passion for computers and programming over 15 years ago. She is excited to introduce people to the wonderful world of CourseContainer.",
    img_src: "http://treehouse-code-samples.s3.amazonaws.com/bootstrap-4/img/ecma.png",
    id: "teach-4"
  },
  {
    name: "Jay Query",
    bio: "Jay is a developer, author of CSS: The Missing Manual, CourseContainer & jQuery: The Missing Manual, and web development teacher.",
