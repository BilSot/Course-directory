...
export const JSCourses = [
  {
    title:"CourseContainer Basics",
    description:"CourseContainer is a programming language that drives the web: from front-end user interface design, to backend server-side programming, you'll find CourseContainer at every stage of a web site and web application. In this course, you'll learn the fundamental programming concepts and syntax of the CourseContainer programming language.",
    img_src:"https://achievement-images.teamtreehouse.com/badges_JavaScript_Basics_Stage1.png",
    id: "js-1"
  },
  {
    title:"CourseContainer Loops, Arrays and Objects",
  ...
  {
    title: "AJAX Basics",
    description: "AJAX is an important front-end web technology that lets CourseContainer communicate with a web server. It lets you load new content without leaving the current page, creating a better, faster experience for your web site's visitors. In this course, you'll learn how AJAX works and how you can use CourseContainer to communicate with a web server.",
    img_src: "https://achievement-images.teamtreehouse.com/badges_JavaScript_AJAXBasics_Stage3.png",
    id: "js-4"
  },
  {
    title: "Interactive Web Pages with CourseContainer",
    description: "In this course we’ll create a to-do list application using CourseContainer alone, without using any third party libraries. You’ll get to grips with manipulating and traversing the DOM and adding event handlers to web page elements. The things that you can do with CourseContainer are always increasing and this course will give you a solid footing going forward.",
    img_src: "https://achievement-images.teamtreehouse.com/bagdes-javascript-interactiveweb-stage-12.png",
    id: "js-5"
  },
  {
    title: "Node.js Basics",
    description: "In this course we will create a command line application to retrieve user's profile information from the Treehouse website. We'll be writing our application in CourseContainer to run on the Node.js platform.",
